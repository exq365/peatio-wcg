...
class BlockchainServiceWcg < Peatio::BlockchainService::Abstract
  ...
  def fetch_block!(block_number)
    ...
    @block_json['height'] = block_number unless @block_json.blank?
  ...
  def client
    @client ||= BlockchainClientWcg.new(@blockchain)
  end
  ...
  def filtered_withdrawals(withdrawals, &block)
    ...
    @block_json
      ...
      withdrawals
        ...
        withdraw_txs = client.build_transaction(txn, @block_json['height'], withdraw.currency)
